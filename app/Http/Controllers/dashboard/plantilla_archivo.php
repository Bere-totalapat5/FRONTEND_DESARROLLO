<?php
    ...
    $juicio=$lista_archivos['response']['datos_toca'][0]['juicio'];
    $accion=$lista_archivos['response']['datos_toca'][0]['accion'];
    $materia=$lista_archivos['response']['datos_toca'][0]['materia'];
    $JP=($lista_archivos['response']['datos_toca'][0]['JP']=='P')?'Procedimiento':'Juicio';
    $M=$lista_archivos['response']['datos_toca'][0]['M'];
    $J=$lista_archivos['response']['datos_toca'][0]['J'];
    $TA=$lista_archivos['response']['datos_toca'][0]['TA'];
    $ACC=$lista_archivos['response']['datos_toca'][0]['ACC'];


    $resolucion_recurre=$lista_archivos['response']['datos_toca'][0]['resolucion_recurre'];
    $recurrente=$lista_archivos['response']['datos_toca'][0]['recurrente'];
    ...
    $html_expedientes="";
    if(isset($lista_archivos['response']['expedientes'][0]['id'])){
        for($i=0; $i<count($lista_archivos['response']['expedientes']); $i++){

            $principal='No';
            if($lista_archivos['response']['expedientes'][$i]['principal']=='1'){
              $principal='Sí';
            }

            $html_expedientes.='<div class="form-layout form-layout-7">
            ...
            <div class="row no-gutters">
              ...
              <div class="col-8 col-sm-9">
                '.$lista_archivos['response']['expedientes'][$i]['numero'].'
              </div><!-- col-8 -->
            </div><!-- row -->
            ...
            <div class="row no-gutters">
              ...
              <div class="col-8 col-sm-9">
                '.$lista_archivos['response']['expedientes'][$i]['nombre_organo'].'
              </div><!-- col-8 -->
            </div><!-- row -->
    ...
    if(isset($lista_archivos['response']['partes']['partes']['actor'])){
        for($i=0; $i<count($lista_archivos['response']['partes']['partes']['actor']); $i++){
            $html_partes_actor.='<div style="border-left: solid 3px #22558c; margin-bottom:5px; padding-left:5px;">'.$lista_archivos['response']['partes']['partes']['actor'][$i]['nombre'].'</div>';
        }
    }
    ...
    if(isset($lista_archivos['response']['partes']['partes']['demandado'])){
        for($i=0; $i<count($lista_archivos['response']['partes']['partes']['demandado']); $i++){
            $html_partes_demandado.='<div style="border-left: solid 3px #22558c; margin-bottom:5px; padding-left:5px;">'.$lista_archivos['response']['partes']['partes']['demandado'][$i]['nombre'].'</div>';
        }
    }
    ...
    if(isset($lista_archivos['response']['partes']['partes']['terceros'])){
        for($i=0; $i<count($lista_archivos['response']['partes']['partes']['terceros']); $i++){
            $html_partes_tercero.='<div style="border-left: solid 3px #22558c; margin-bottom:5px; padding-left:5px;">'.$lista_archivos['response']['partes']['partes']['terceros'][$i]['nombre'].'</div>';
        }
    }
