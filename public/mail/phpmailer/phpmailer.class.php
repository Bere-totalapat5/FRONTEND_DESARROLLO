...
class PHPMailer {
   ...
   * by SERVER_NAME is used or 'mydbserv.localdomain'.
   * @var string
   */
  public $Hostname          = '';
 ...
 */
  ...
  */
  ...
  /**
   * Returns the server hostname or 'mydbserv.localdomain' if unknown.
   * @access private
   * @return string
   */
