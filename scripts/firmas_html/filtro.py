...
if __name__ == "__main__":
    ...
    if debuging:
        ...
        try:
            ...
            print "Error(2):", str(e) # sys.exc_info()[0]
            sys.exit(2)
    ...
    if debuging:
        ...
        try:
            ...
            print "Error(3.0):", str(e) # sys.exc_info()[0]
            sys.exit(3)
        try:
            parser.feed(data)
        except Exception as e:
            print "Error(3.1):", str(e) # sys.exc_info()[0]
            sys.exit(3)
        try:
            data = "".join( parser.pieces )
        except Exception as e:
            print "Error(3.2):", str(e) # sys.exc_info()[0]
            sys.exit(3)
        parser.close()
    try:
        ...
        print "Error(4):", str(e) # sys.exc_info()[0]
        sys.exit(4)
    try:
        arg = sys.argv[2]
