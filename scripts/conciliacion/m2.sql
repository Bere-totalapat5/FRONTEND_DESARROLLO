...
COALESCE(su.incluidos,0) 'Exp. Gratis', 
IF(su.adicionales<51, su.adicionales, 0) 'Exp. $20',
IF(su.adicionales>50 AND su.adicionales<101 , su.adicionales, 0) 'Exp. $15',
IF(su.adicionales>100 AND su.adicionales<201 , su.adicionales, 0) 'Exp. $10',
IF(su.adicionales>200, su.adicionales, 0) 'Exp. $5',
