...
## #NO python3 extrae_boletin3.py -e -f ${fpub} > /var/www/public_html/temporales72/extrae_boletin_${fpub}.out 2>> /tmp/bj_${fpub}
## #OK python3 extrae_boletin3_conedictos.py -e -f ${fpub} > /var/www/public_html/temporales72/extrae_boletin_${fpub}.out 2>> /tmp/bj_${fpub}
## python3 extrae_boletin3_conedictos.py -f ${fpub} > /var/www/public_html/temporales72/extrae_boletin_${fpub}.out 2>> /tmp/bj_${fpub}
## 
## date >> /tmp/bj_${fpub}
...
echo $b
#NO python3 distribuye-boletin.py "${b}" /tmp/bj_${fpub}
#OK python3 email_por_awsses.py "${b}" ${fpub} /tmp/bj_${fpub} >  /tmp/em_${fpub} 2&1
