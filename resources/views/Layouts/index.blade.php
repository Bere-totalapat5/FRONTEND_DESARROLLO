...
<div style="background-color:#FFFFFF; width:100%;">
  ...
  @endif
  <center style="background: linear-gradient(90deg, rgba(244,245,247,1) 0%, rgba(244,245,247,1) 49%, rgba(134,145,55,1) 50%, rgba(134,145,55,1) 100%);margin-left:1%;margin-right:1%; background-size: auto 77px;background-repeat: no-repeat;background-position: center;">
...
<div class="slim-header">
        ...
        <div class="dropdown dropdown-demo" >
          ...
          <div class="dropdown-menu pd-0 wd-sm-350">
            <div style="padding: 10px;">
              ...
              <h6 style="margin-bottom:0px;" class="tx-bold tx-inverse titulo-primario">{{strtoupper($sesion['grupo_trabajo_tipo_area'])}} 
                {{-- @if($sesion['usuario_secretaria']!="") {{$sesion['usuario_secretaria']}} @endif --}}
              </h6>
  ...
  @isset($request->menu_general['response'])
    <div class="slim-navbar" style="z-index: 1100">
      <div class="container"> 
        <ul class="nav">
...
<div class="slim-mainpanel" style="max-width: 1650px; margin-left: auto;margin-right: auto;">
  <div class="pd-l-5 pd-r-5 pd-md-l-30 pd-md-r-30">
    ...
    <div class="manager-wrapper">
      ...
      <div class="manager-left">
        @isset($request->menu_general['response'])
          @if(utilidades::buscarPermisoMenu($request->menu_general['response'], 2, 0))
            <a href="/menu_permisos" class="btn btn-contact-new" style="margin: 0px; margin-bottom:5px;">Administrar permisos</a>
          @endif
