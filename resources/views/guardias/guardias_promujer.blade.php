...
@section('contenido-pageheader')
  ...
  <h6 class="slim-pagetitle">Guardias Promujer</h6>
@endsection
        ...
        <div class="d-flex justify-content-between" style="align-items: center;">
          ...
          <div class="row justify-content-end" style="width:80%;">
              ...
              @foreach($acciones as $acc)
                @if($acc['id_vista_accion'] == 36 and $acc['valor'] != 0)
                            ...
                            <div class="col-lg-6">
                              <div class="form-group">
                                ...
                                <select class="form-control select2" id="tipoB" name="tipoB" autocomplete="off">
                                  <option selected value="PROMUJER-AMBAS">Seleccionar</option>
    ...
    <script>
      ...
      function buscar(pagina){
        ...
        $.ajax({
          ...
          data:{
            unidad: $('#unidad').val(),
            tipo: $('#tipoB').val() == 'PROMUJER-AMBAS' ? 'G-PROMUJER': ($('#tipoB').val() == 'GFS-PROMUJER' ? 'GFS-PROMUJER': 'G-PROMUJER'),
            pagina,
          },
          success:function(response){
            $('#bodyGuardias').html('');
            ...
            if(response.status==100){
              ...
              $(response.response).each(function(index, guardia){
                ...
                const tr=`<tr>
                            ...
                            @foreach($acciones as $acc)
                            @if($acc['id_vista_accion'] == 37 and $acc['valor'] != 0)
          ...
          <div class="row form-layout">
            <div class="col-lg-12">
							<div class="form-group">
								...
								<select class="form-control select2" id="tipo" name="tipo" autocomplete="off">
