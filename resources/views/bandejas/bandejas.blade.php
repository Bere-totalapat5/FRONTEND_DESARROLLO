        ...
        <div class="section-wrapper">
            ...
            <div class="table-wrapper">
                ...
                <div style="float: right">
                    ...
                    -->
                    <a href="javascript:void(0)" onclick="">@if($bandeja=='revision')Autorizar @else Firmar @endif selección</a>   |    <a href="javascript:void(0)" onclick="">@if($bandeja=='revision')Autorizar @else Firmar @endif 10 acuerdos</a>
                </div>
...
<script>
    ...
    */
    ...
    function actualizarAcuerdoDocumento(acuerdo_id, codigo_organo, id_flujo_participante, tipo_firma){
        ...
        if(tipo_firma=="MPSD"){
            alert("Esta es una Mala Publicación sin Documento");
            setTimeout(function(){
                $('#modaldemo3').hide();
            }, 1000);
        }
