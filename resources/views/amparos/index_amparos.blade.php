...
@section('contenido-pageheader')
    ...
    <ol class="breadcrumb slim-breadcrumb d-none d-md-flex">
      ...
      <li class="breadcrumb-item active" aria-current="page">Recursos de amparo</li>
    </ol>
    <h6 class="slim-pagetitle" id="title_tareas">Recursos de amparo</h6>
        ...
        <div class="col-lg-12">
          <table  data-swipe-ignore="true" id="tableAmparos" class="display dataTable dtr-inline collapsed" style="overflow-x: auto; padding-left:0; padding-rigth:0">
            <thead style="background-color: #EBEEF1; color: #000;" data-swipe-ignore="true">
              <th style="min-width: 80px; text-align:center;" class="acciones">Acciones</th>
              <th style="min-width: 140px; text-align:center;" class="folio_registro">Folio de registro</th>
              <th style="min-width: 180px; text-align:center;" class="carpeta_amparo">Carpeta de amparo</th>
              <th style="min-width: 320px; text-align:center;" class="fecha_registro">Fecha de registro</th>
              <th style="min-width: 120px; text-align:center;" class="tipo_amparo">Tipo amparo</th>
              <th style="min-width: 180px; text-align:center;" class="carpeta_referida">Carpeta referida</th>
              <th style="min-width: 100px; text-align:center;" class="no_juicio_amparo">No. de juicio de amparo</th>
              <th style="min-width: 240px; text-align:center;" class="autoridad_requiriente">Autoridad requiriente</th>
              <th style="min-width: 190px; text-align:center;" class="entidad_federativa_requiriente">Entidad federativa requiriente</th>
              <th style="min-width: 160px; text-align:center;" class="registrado_por">Registrado por</th>
              <th style="min-width: 210px; text-align:center;" class="comentarios_adicionales">Comentarios adicionales</th>
              <th style="min-width: 120px; text-align:center;" class="situacion">Situación</th>
            </thead>
            <tbody id="bodyTareas">
            </tbody>
          </table>
...
@section('seccion-scripts-libs')
  ...
  <script src="/js/amparos/amparos.js?v=@php echo time();@endphp"></script>
...
@section('seccion-modales')
      ...
      <div class="modal-content tx-size-sm">
        ...
        <div class="modal-body pd-20">
          <div class="form-layout">
            <form action="" onsubmit="return false" id="formNewAmparo" autocomplete="nope"> 
                  ...
                  <div class="form-group">
                    ...
                    <div class="d-flex">
                      <div class="input-group">
                        ...
                        <input  type="text" class="form-control time-edit-A clockpicker-A" id="horaRecepcion" name="hora_recepcion" placeholder="hh:mm" autocomplete="nope" data-align="top" data-autoclose="true" value="{{date('H:i')}}">
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="row pd-l-10">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control fc-datepicker-A" placeholder="DD/MM/AAAA" id="fecha_termino"  name="fecha_termino" autocomplete="off" onchange="obtenerFechaTermino()" value="{{date('d-m-Y')}}">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="d-flex">
                          <div class="input-group">
                            ...
                            <input  type="text" class="form-control time-edit-A clockpicker-A" id="hora_termino" name="hora_termino" placeholder="hh:mm" autocomplete="off"  data-align="top" data-autoclose="true" onchange="obtenerFechaTermino()" value="{{date('H:i')}}">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group mg-b-10-force pd-t-15">
                          ...
                          <input class="form-control input-number" type="text" name="dias" id="dias" placeholder="Días" oninput="obtenerFechaTermino()">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group mg-b-10-force pd-t-15">
                          <label class="form-control-label">Horas:</label>
                          <input class="form-control input-number" type="text" name="horas" id="horas" placeholder="Horas" oninput="obtenerFechaTermino()">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-md-4 divTermino" style=" display: flex; align-items: center;">
                  <div class="form-group pd-t-15" style="margin-left: auto; margin-right: auto; width: 100%; height: 100%; padding: 2.3em 0;">
                    <input class="form-control  mg-t-10" type="text" name="" id="fecha_hora_termino" placeholder="" readonly>
                  </div>
                </div>
                <div class="col-12">
                  <div class="form-group mg-b-10-force">
  ...
  <div id="modalEliminar" class="modal fade"  data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title"></h5>
        </div>
        <div class="modal-body" style="display: flex;justify-content: center;align-items: center;flex-direction: column;" id="modalBodyAmpa">
          
          <h5 id="menajeBodyAmpa"></h5>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal" data-toggle="modal" data-target="#modalEliminar" >Cerrar</button>
          <button type="button" class="btn btn-danger" id="btnCancelarCarpeta" onclick="cancelarCarpeta()">Cancelar</button>
        </div>
      </div>
    </div>
  </div>
