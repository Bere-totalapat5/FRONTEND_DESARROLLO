...
@section('contenido-principal') 
    ...
    <div class="section-wrapper">
        ...
        <form method="POST" action="{{ route('promociones.promocion_guardar') }}" enctype="multipart/form-data" name="registration" onsubmit="return validateForm()">
            ...
            <div class="table-wrapper">
                ...
                <div class="form-layout-footer">
                    <button class="btn btn-primary btn-block mg-b-10">Guardar promoción</button>
