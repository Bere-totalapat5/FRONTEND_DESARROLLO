                ...
                @isset($lista["response"])
                    ...
                    @foreach ($lista["response"] as $resolucion)
                       <tr class="data-row-id-{{$i}}">
                        ...
                        <td class="romperCadena">
                            <strong>@if($bandeja=="iniciales") DEMANDA @else PROMOCIÓN  @endif</strong><br>
                ...
                success:function(data){
                    ...
                    if(data.status==100){
                        ...
                        for(var i=0; i<data.response.length; i++){
                            ...
                            expediente_txt='<strong>'; @if($bandeja=="iniciales") expediente_txt+='DEMANDA'; @else expediente_txt+='PROMOCIÓN';  @endif expediente_txt+='</strong><br>';
