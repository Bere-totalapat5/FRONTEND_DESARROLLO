      ...
      <div class="manager-wrapper">
        ...
        <div class="manager-left">
          ...
          <nav class="nav" id="">
              ...
              <a href="/estadistica/" class="nav-link {{ (request()->is('estadistica')) ? 'active' : '' }} ">
                <span>Creación de carátulas</span>
              </a>
            
              <a href="/estadistica/consulta/" class="nav-link {{ (request()->is('estadistica/consulta')) ? 'active' : '' }} ">
                <span>Consulta de carátulas</span>
              </a>
