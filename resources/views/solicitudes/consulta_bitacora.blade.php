...
@section('contenido-pageheader')
 <ol class="breadcrumb slim-breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="#"> Consulta de Bitácora</a></li>
 </ol>
 <h6 class="slim-pagetitle"> Consulta de Bitácora</h6>
@endsection
                ...
                <div id="table-bitacora" class="mg-b-20">
                    <table id="bitacoraTable" class="display dataTable dtr-inline collapsed d-block" style="overflow-x: auto; padding-left:0; padding-rigth:0" role="grid" aria-describedby="example_info">
                        <thead style="background-color: #EBEEF1; color: #000; text-align:center">
                            <tr><!--*** -->
                                <th style="cursor:pointer" class="creacion" name="creacion">Fecha</th>
                                <th style="cursor:pointer" class="usuario_responsable" name="usuario_responsable">Usuario</th>
                                <th style="cursor:pointer" class="nombre_responsable" name="nombre_responsable">Nombre completo</th>
                                <th style="cursor:pointer" class="puesto_responsable" name="puesto_responsable">Puesto</th>
                                <th style="cursor:pointer" class="nombre_unidad" name="nombre_unidad">Adscripción</th>
                                <th style="cursor:pointer" class="modulo" name="modulo">Módulo</th>
                                <th style="cursor:pointer" class="actividad" name="actividad">Actividad</th>


                           {{--      <th class="datos_antes">Dato Anterior</th>
                                <th class="datos_nuevos">Dato Nuevo</th> --}}
