      ...
      <div class="form-layout">
        <div class="row mg-b-25 " id="datosSolicitudAudiencia">{{-- datos de solicitud de audiencia --}}
          ...
          <div class="col-lg-3">
            <div class="form-group mg-b-10-force">
              ...
              <input class="form-control" type="text" name="carpeta_juidicial" id="carpetaJudicial" value="" placeholder="N/E" autocomplete="off" disabled>
            </div>
          </div><!-- col-3 -->
          <div class="col-lg-6">
            <div class="form-group">
              <label class="form-control-label">Número de Carpeta de Investigación: <span class="tx-danger">*</span></label>
              <input class="form-control" type="text" name="numero_carpeta_investigacion" id="numeroCarpetaInvestigacion" value=""  placeholder="Número de Carpeta de Investigación" autocomplete="off">
            </div>
          </div><!-- col-3 -->
          <div class="col-lg-3">
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="d-flex">
                <div class="input-group">
                  ...
                  <input  type="text" class="form-control" id="horaRecepcion" name="hora_recepcion" placeholder="hh:mm" autocomplete="off">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="mg-b-25 d-none" id="sujetosProcesales">{{-- <sujetos procesales> --}}      
          <div class="row">
            <div class="col-lg-6">
              <div class="form-group">
                <label class="form-control-label">Tipo Parte: <span class="tx-danger">*</span></label>
              ...
              <table  class="display dataTable dtr-inline collapsed d-block" style="overflow-x: auto; padding-left:0; padding-rigth:0" role="grid" aria-describedby="example_info">
                <thead>
                    <tr style="background-color: #EBEEF1; color: #000;">
                        ...
                        <th class="tipo-parte">Tipo Parte</th>
      ...
      $.ajax({
        ...
        success:function(response){
          if(response.status==100){
            ...
            $(response.datos).each((index, modalidad)=>{
      ...
      $.ajax({
        ...
        success:function(response){
          ...
          if(response.status==100){
            ...
            $(response.datos).each((index, agencia)=>{
      ...
      $.ajax({
        ...
        success:function(response){
          if(response.status==100){
            ...
            $(response.datos).each(function(index, datosMunicipio){
    ...
    function muestraDelitosSujeto(indexSujeto){
      ...
      const tableHead= `<thead style="background-color: #EBEEF1; color="#000">
                        <tr>
                          ...
                          <th>Delito</th>
                          <th>Modalidal de Delito</th>
                          <th>Calificativo</th>
                          <th>Grado de Realización</th>
                        </tr>
                      </thead>`;
      let listaDelitos='';
      ...
      $(delitos).each(function(index, datosDelito){
        ...
        tr=`<tr data-delito=${index}>
              ...
              <td>${delito_text}</td>
              <td>${modalidad_text}</td>
              <td class="tx-uppercase">${calificativo_text}</td>
              <td>${grado_realizacion_text}</td>
            </tr>
        ${delito.delito}<br>`;
      ...
      if(validaDocumento=='' || validaDocumento==null){
        ...
        $.ajax({
          ...
          data:{
            ...
            tipo_audiencia:$('#tipAudiencia').val(),
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content tx-size-sm">
        <div class="modal-body tx-center pd-y-20 pd-x-20">
          ...
          <p class="mg-b-20 mg-x-20">La solicitud se ha enviado correctamente.</p>
          <button type="button" class="btn btn-success pd-x-25" data-dismiss="modal" aria-label="Close" onclick="window.location.reload()">Aceptar</button>
        </div><!-- modal-body -->
      </div><!-- modal-content -->
    </div><!-- modal-dialog -->
  </div><!-- modal -->
