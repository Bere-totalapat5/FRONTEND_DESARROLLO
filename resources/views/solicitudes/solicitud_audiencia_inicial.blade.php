...
@section('contenido-pageheader')
  <ol class="breadcrumb slim-breadcrumb"> 
    ...
    <li class="breadcrumb-item active" aria-current="page">Registro de Solicitudes Iniciales</li>
  </ol>
  <h6 class="slim-pagetitle">Registro de Solicitudes Iniciales</h6>
@endsection
  ...
  <div class="section-wrapper mg-b-100">
    ...
    @else
      <table class="mg-b-20 table-steps">
        <tr>
          <td class="td-step">
            <p class="step activo d-inline-block d-md-flex" id="step-datos-solicitud"><span class="num-step">1</span><span class="text-step d-none d-md-block">Datos de Solicitud Inicial</span></p>
          </td>
          <td class="td-step">
      ...
      <div class="form-layout">
        <form id="form_nueva_solucitud" action="/" onsubmit="return false;" autocomplete="nope">
          <div class="row mg-b-25 " id="datosSolicitudAudiencia">{{-- datos de solicitud de audiencia --}}
            <div class="col-lg-3">
              <div class="form-group">
                ...
                <input class="form-control" type="text" name="folio_solicitud_audiencia" id="folioSolicitudAudiencia" placeholder="Folio de Solicitud de Audiencia" autocomplete="nope" disabled>
              </div>
            </div><!-- col-3 -->
            <div class="col-lg-3">
              <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control fc-datepickerA" placeholder="DD/MM/AAAA" id="fechaSolicitud"  name="fecha_solicitud" autocomplete="nope" disabled>
                </div>
              </div>
            </div><!-- col-3 -->
            <div class="col-lg-3">
              <div class="form-group mg-b-10-force">
                ...
                <input class="form-control" type="text" name="fenece" id="fenece" value="" placeholder="N/E" autocomplete="nope" disabled>
              </div>
            </div><!-- col-3 -->
            <div class="col-lg-3">
              <div class="form-group mg-b-10-force">
                <label class="form-control-label">Carpeta Judicial:</label>
                <input class="form-control" type="text" name="carpeta_juidicial" id="carpetaJudicial" value="" placeholder="N/E" autocomplete="nope" disabled>
              </div>
            </div><!-- col-3 -->
            <div class="col-lg-6">
              <div class="form-group">
                <label class="form-control-label">Número de Carpeta de Investigación: <span class="tx-danger">*</span></label>
                <input class="form-control" type="text" name="numero_carpeta_investigacion" id="numeroCarpetaInvestigacion" value=""  placeholder="Número de Carpeta de Investigación" autocomplete="nope">
              </div>
            </div><!-- col-3 -->
            <div class="col-lg-3">
              <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control fc-datepickerA" placeholder="DD-MM-AAAA" value="{{date('d-m-Y')}}" id="fechaRecepcion" name="fecha_recepcion" autocomplete="nope">
                </div>
              </div>
            </div><!-- col-3 -->
            <div class="col-lg-3">
              <div class="form-group">
                ...
                {{-- <div class="d-flex">
                  <div class="input-group">
                    ...
                    <input  type="text" class="form-control" id="horaRecepcion" name="hora_recepcion" placeholder="hh:mm" autocomplete="nope">
                  </div>
                </div> --}}
              

                <div class="input-group clockpicker" data-placement="left" data-align="top" data-autoclose="true">
                  <input type="text" class="form-control" value="" id="horaRecepcion" name="hora_recepcion" autocomplete="nope">
            ...
            <div class="col-lg-9">
              <div class="form-group">
                ...
                <select class="form-control select2-show-search valid" id="tipoAudiencia" name="tipo_audiencia" autocomplete="nope">
              ...
              <div class="row">
                ...
                <div class="col-6">
                  <div class="toggle-wrapper" id="urgente">
                    <div class="toggle-on toggle-light primary"></div>
                  </div>
                </div>
              </div>
            </div> 
            ...
            <div class="col-lg-6 mg-t-20">
              <div class="row">
                <div class="col-6">
                  <label class="form-control-label">¿Prisión Preventiva Oficiosa?: <small>(Sí = Delito oficioso, No = Delito de querella</small></label>
                </div>
                <div class="col-6">
            ...
            <div class="col-lg-6">
              <div class="form-group" id="divDeclaratoria">
                <label class="form-control-label mg-t-20">Declaratoria: <span class="tx-danger">*</span></label>
                <div class="d-inline-block mg-l-10">
                  <label class="rdiobox d-inline-block mg-l-20">
                    <input name="declaratoria" type="radio" value="1">
                    <span class="pd-l-0">1</span>
                  </label>
                  <label class="rdiobox d-inline-block mg-l-20">
                    <input name="declaratoria" type="radio" value="2">
                    <span class="pd-l-0">2</span>
                  </label>
                  <label class="rdiobox d-inline-block mg-l-20">
                    <input name="declaratoria" type="radio" value="3">
                    <span class="pd-l-0">3</span>
                  </label>
                </div>
              </div>
            </div>
          ...
          <div class="mg-b-25 d-none" id="sujetosProcesales">{{-- <sujetos procesales> --}}      
            <div class="row">
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <select class="form-control " id="tipoParte" name="tipo_parte" autocomplete="nope">
                      ...
                      @foreach ($calidad_juridica as $calidad)
                        @if($calidad['id_calidad_juridica']!=56 && $calidad['id_calidad_juridica']!=44)
                          @if( in_array($calidad['id_calidad_juridica'], [52,46,2,6]))
                            @if($calidad['id_calidad_juridica']==46)
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <select class="form-control select2" id="tipoPersona" name="tipo_persona" autocomplete="nope">
                      <option selected disabled value="">Elija una opción</option>
              ...
              <div class="col-lg-6 fisica">
                <div class="form-group">
                  ...
                  <select class="form-control select2" id="nacionalidad" name="nacionalidad" autocomplete="nope">
              ...
              <div class="col-lg-6 fisica">
                <div class="form-group">
                  ...
                  <select class="form-control " id="otraNacionalidad" name="otra_nacionalidad" autocomplete="nope" disabled>
              ...
              <div class="col-lg-4 fisica">
                <div class="form-group mg-b-10-force">
                  ...
                  <input class="form-control" type="text" name="curp" id="curp" autocomplete="nope">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-4">
                <div class="form-group mg-b-10-force">
                  <label class="form-control-label">RFC:</label>
                  <input class="form-control" type="text" name="rfc" id="rfc" autocomplete="nope">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-8 moral d-none">
                <div class="form-group mg-b-10-force">
                  <label class="form-control-label">Razón Social:</label>
                  <input class="form-control" type="text" name="razon_social" id="razonSocial" autocomplete="nope">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-4 fisica">
                <div class="form-group mg-b-10-force">
                  <label class="form-control-label">Cédula Profesional:</label>
                  <input class="form-control" type="text" name="cedula_profesional" id="cedulaProfesional" autocomplete="nope">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-4 fisica">
                <div class="form-group mg-b-10-force">
                  <label class="form-control-label">Nombre(s): <span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="nombre" id="nombre" autocomplete="nope">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-4 fisica">
                <div class="form-group mg-b-10-force">
                  <label class="form-control-label">Apellido Paterno: <span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="apellido_paterno" id="apellidoPaterno" autocomplete="nope">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-4 fisica">
                <div class="form-group mg-b-10-force">
                  <label class="form-control-label">Apellido Materno:</label>
                  <input class="form-control" type="text" name="apellido_materno" id="apellidoMaterno" autocomplete="nope">
                </div>
              </div><!-- col-4-->
              <div class="col-lg-3 fisica">
                <div class="form-group">
                  <label class="form-control-label">Genero: <span class="tx-danger">*</span></label>
                  <select class="form-control select2" id="genero" name="genero" autocomplete="nope">
                      <option selected disabled value="">Elija una opción</option>
              ...
              <div class="col-lg-3 fisica">
                <div class="form-group">
                  ...
                  <select class="form-control select2" id="estadoCivil" name="estado_civil" autocomplete="nope">
                      <option selected   value="">Elija una opción</option>
              ...
              <div class="col-lg-3 fisica">
                <div class="form-group">
                  ...
                  <div class="input-group">
                      ...
                      <input type="text" class="form-control fc-datepickerA" placeholder="DD/MM/AAAA" id="fechaNacimiento" name="fecha_nacimiento" autocomplete="nope">
                  </div>
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-3 fisica">
                <div class="form-group mg-b-10-force">
                  ...
                  <input class="form-control input-number" type="text" name="edad" id="edad" autocomplete="nope">
                </div>
              </div><!-- col-4-->
            </div>          
                    ...
                    <div class="row">
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <select class="form-control" id="estado" name="estado" autocomplete="nope">
                              <option selected   value="">Elija una opción</option>
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <select class="form-control" id="municipio" name="municipio" autocomplete="nope">
                      ...
                      <div class="col-lg-4">
                        <div class="form-group mg-b-10-force">
                          ...
                          <input class="form-control" type="text" name="localidad" id="localidad" autocomplete="nope">
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="form-group mg-b-10-force">
                          <label class="form-control-label">Calle:</label>
                          <input class="form-control" type="text" name="calle" id="calle" autocomplete="nope">
                        </div>
                      </div><!-- col-4 -->
                      <div class="col-lg-3">
                        <div class="form-group mg-b-10-force">
                          <label class="form-control-label">Número Exterior:</label>
                          <input class="form-control" type="text" name="numero_exterior" id="numeroExterior" autocomplete="nope">
                        </div>
                      </div><!-- col-4 -->
                      <div class="col-lg-3">
                        <div class="form-group mg-b-10-force">
                          <label class="form-control-label">Número Interior:</label>
                          <input class="form-control" type="text" name="numero_interior" id="numeroInterior" autocomplete="nope">
                        </div>
                      </div><!-- col-4-->
                      <div class="col-lg-9">
                        <div class="form-group mg-b-10-force">
                          <label class="form-control-label">Colonia:</label>
                          <input class="form-control" type="text" name="colonia" id="colonia" autocomplete="nope">
                        </div>
                      </div><!-- col-4 -->
                      <div class="col-lg-3">
                        <div class="form-group mg-b-10-force">
                          <label class="form-control-label">Código Postal:</label>
                          <input class="form-control" type="text" name="codigo_postal" id="codigoPostal" autocomplete="nope">
                        </div>
                      </div><!-- col-4 -->
                      <div class="col-lg-8">
                        <div class="form-group mg-b-10-force">
                          <label class="form-control-label">Entre la Calle:</label>
                          <input class="form-control" type="text" name="entre_calle" id="entreCalle" autocomplete="nope">
                        </div>
                      </div><!-- col-4-->
                      <div class="col-lg-12">
                        <div class="form-group mg-b-10-force">
                          <label class="form-control-label">Otras Referencias:</label>
                          <input class="form-control" type="text" name="otras_referencias" id="otrasReferencias" autocomplete="nope">
                        </div>
                      </div><!-- col-4-->
                      <div class="col-12">
            ...
            <div  class="d-flex mg-t-5" id="botonesPartes">
              <button class="btn btn-primary bd-0 d-inline-block ml-auto" id="agregarParte" onclick="agregaParte()">Agregar Parte</button>
            </div>
            <div class="mg-t-15">
              ...
              <div>
                <table  class="display dataTable dtr-inline collapsed" style="overflow-x: auto; padding-left:0; padding-rigth:0;" role="grid" aria-describedby="example_info" id="tablePartes">
                  <thead>
          ...
          <div class="row mg-b-25 d-none" id="datosFiscalia">
            <div class="col-lg-12">
              <div class="form-group">
                ...
                <select class="form-control select2" id="fiscalia" name="fiscalia" autocomplete="nope">
                    <option selected disabled  value="">Elija una opción</option>
            ...
            <div class="col-lg-4">
              <div class="form-group">
                ...
                <select class="form-control select2" id="agencia" name="agencia" autocomplete="nope">
                    <option selected value="">Elija una opción</option>
                </select>
              </div>
            </div><!-- col-4-->
            <div class="col-lg-4">
              <div class="form-group">
                ...
                <select class="form-control select2" id="unidadInvestigacion" name="unidad_investigacion" autocomplete="nope">
                    <option selected disabled value="">Elija una opción</option>
            ...
            <div class="col-lg-4">
              <div class="form-group mg-b-10-force">
                ...
                <input class="form-control" type="text" name="coordinacion_territorial" id="coordinacionTerritorial" autocomplete="nope">
              </div>
            </div><!-- col-4-->
            <div class="col-12">
            ...
            <div class="col-lg-4">
              <div class="form-group mg-b-10-force">
                <label class="form-control-label">Nombre(s): <span class="tx-danger">*</span></label>
                <input class="form-control" type="text" name="nombre_fiscal" id="nombreFiscal" autocomplete="nope">
              </div>
            </div><!-- col-4 -->
            {{-- <div class="col-lg-3">
              <div class="form-group mg-b-10-force">
                <label class="form-control-label">Apellido Paterno: <span class="tx-danger">*</span></label>
                <input class="form-control" type="text" name="apellido_paterno_fiscal" id="apellidoPaternoFiscal" autocomplete="nope">
              </div>
            </div><!-- col-4 -->
            <div class="col-lg-3">
              <div class="form-group mg-b-10-force">
                <label class="form-control-label">Apellido Materno:</label>
                <input class="form-control" type="text" name="apellido_materno_fiscal" id="apellidoMaternoFiscal" autocomplete="nope">
              </div>
            </div><!-- col-4 --> --}}
            <div class="col-lg-4">
              <div class="form-group mg-b-10-force">
                <label class="form-control-label">CURP:</label>
                <input class="form-control" type="text" name="curp_fiscal" id="curpFiscal" autocomplete="nope">
              </div>
            </div><!-- col-4 -->
            <div class="col-lg-4">
              <div class="form-group mg-b-10-force">
                <label class="form-control-label">Correo Electrónico:</label>
                <input class="form-control correo_electronico_fiscal" type="text" name="correo_electronico_fiscal" id="correoFiscal" autocomplete="nope">
              </div>
            </div><!-- col-4 -->  
          </div>
...
@section('seccion-scripts-functions')
  ...
  <script>
    ...
    $('#agregarAlias').click(function(){
      $('#datosAlias').append(`
        <div class="col-md-6 datos-alias" style="border: 1px solid #EEE; margin: 0 10px;">
          <div class="">
          ...
          <div class="">
            <div class="form-group mg-b-10-force">
              ...
              <input class="form-control alias" type="text" name="alias" autocomplete="nope">
            </div>
          </div><!-- col-3-->
        </div>`);
    });
    ...
    $('#agregarCorreo').click(function(){
      $('#correos').append(`
        <div class="coo-md-5 datos-correo" style="border: 1px solid #EEE">
          <div class="">
          ...
          <div class="">
            <div class="form-group mg-b-10-force">
              <label class="form-control-label">Correo Electrónico:</label>
              <input class="form-control correo-electronico" type="text" name="correo_electronico" autocomplete="nope">
            </div>
          </div><!-- col-3-->
        </div>`);
    });
      ...
      $('#telefonos').append(`<div class="row datos-telefono">
                                ...
                                <div class="col-lg-3">
                                  <div class="form-group">
                                    ...
                                    <select class="form-control tipo-telefono"  name="tipo_telefono" autocomplete="nope">
                                ...
                                <div class="col-lg-4">
                                  <div class="form-group mg-b-10-force">
                                    ...
                                    <input class="form-control numero-telefono" type="text" name="numero_telefono" autocomplete="nope">
                                  </div>
                                </div><!-- col-3-->
                                <div class="col-lg-2">
                                  <div class="form-group mg-b-10-force">
                                    <label class="form-control-label">Extension:</label>
                                    <input class="form-control extension" type="text" name="estension" autocomplete="nope">
                                  </div>
                                </div><!-- col-3-->
                              </div>`);
    ...
    function validaDatosSolicitud(){
      ...
      if(!$('input:radio[name=declaratoria]:checked').length) return {'estatus':0,'campo':'divDeclaratoria','error':'No ha seleccionado la declaratoria'};
    ...
    function editarSujeto(index){
      ...
      if(alias.length){
        ...
        $(alias).each(function(index, ali){
          sAlias += `
            <div class="col-md-5 datos-alias" style="border: 1px solid #EEE; margin: 0 10px;">
              <div class="">
                <p class="tx-right tx-danger"><i class="fa fa-close borrar-alias"></i></p>
              </div>
              <div class="">
                <div class="form-group mg-b-10-force">
                  <label class="form-control-label">Alias:</label>
                  <input class="form-control alias" type="text" name="alias" autocomplete="nope" value="${ali.descripcion}">
                </div>
              </div><!-- col-3-->
            </div>
          `;
        ...
        $(correos).each(function(index, correo){
          sCorreos=sCorreos.concat(`<div class="row datos-correo">
                                      ...
                                      <div class="col-8">
                                        <div class="form-group mg-b-10-force">
                                          <label class="form-control-label">Correo Electrónico:</label>
                                          <input class="form-control correo-electronico" type="text" name="correo_electronico" autocomplete="nope" value="${correo.correo}">
                                        </div>
                                      </div><!-- col-3-->
                                    </div>`);
        });
        ...
        $(telefonos).each(function(index, telefono){
          sTelefonos=sTelefonos.concat(`<div class="row datos-telefono">
                                          ...
                                          <div class="col-lg-4">
                                            <div class="form-group mg-b-10-force">
                                              <label class="form-control-label">Número:</label>
                                              <input class="form-control numero-telefono" type="text" name="numero_telefono" autocomplete="nope" value="${telefono.numero}">
                                            </div>
                                          </div><!-- col-3-->
                                          <div class="col-lg-2">
                                            <div class="form-group mg-b-10-force">
                                              <label class="form-control-label">Extension:</label>
                                              <input class="form-control extension" type="text" name="estension" autocomplete="nope" value="${telefono.extension}">
                                            </div>
                                          </div><!-- col-3-->
                                        </div>`);
        });
      ...
      $('#botonesPartes').html(`<button type="button" class="btn btn-secondary d-inline-block btn-edicion mg-l-auto" onclick="limpiarCamposSujetos()">Cancelar</button>
    ...
    function editarDatosSujeto(indexEditado){
      ...
      muestraSujetosProcesales();
      limpiarCamposSujetos();
      $('#botonesPartes').html('<button class="btn btn-primary bd-0 d-inline-block ml-auto" id="agregarParte" onclick="agregaParte()">Agregar Parte</button');
    ...
    function limpiarCamposSujetos(){
      ...
      if( $('#collapseAlias').hasClass('show') ) $('#headingAlias').find('a').click();
      if( $('#collapseContacto').hasClass('show') ) $('#accordionContacto').find('a').click();
      ...
      if(ext!=''){
        if( !['.pdf', '.PDF'].includes(ext) ){
          ...
          if (input.files && input.files[0]) {
            const url_doc = await vista_previa(ext);
            const nombre = file.replaceAll( 'C:\\fakepath\\', '' ).replaceAll( '.pdf', '' );
            const reader = new FileReader();

            dataDoc = { nombre, url_doc, ext };

            reader.onload = e=> {
                $('#documentoPDF').attr('data', url_doc); 
                $('#documentoPDF').removeClass('d-none');
                // $('#bDoc').val(e.target.result.split('base64,')[1]);
                // $('#nomDocPDF').val(nombre);
            }
    ...
    function vista_previa(ext) {

      return new Promise( resolve => {

        const data = new FormData( $('#cargarDocumento')[0] );
      ...
      if( !dataDoc.url_doc ){
        ...
        $.ajax({
          ...
          data:{
            ...
            documento:dataDoc,
            nombre_documento:$('#nomDocPDF').val(),
            declaratoria: $('input:radio[name="declaratoria"]:checked').val(),
              ...
              if(response.response_carpeta.status==100){
                ...
                if(response.response_carpeta.response){
                  ...
                  if(response.response_carpeta.response.fecha_asignacion_carpeta)
                    fehca_asignacion = response.response_carpeta.response.fecha_asignacion_carpeta.split(' ')[0];
                    
                  if(response.response_carpeta.response.fecha_asignacion) 
                    fehca_asignacion = response.response_carpeta.response.fecha_asignacion.split(' ')[0];
                ...
                tabla=tabla.concat(`<tr>
                                    ...
                                    <tr>
                                      ...
                                      <td>${moment(fehca_asignacion).format('ll')}</td>
                                    </tr>
                                    <tr>
        ...
        <div class="modal-body pd-20">
          <form onsubmit="return false;" id="cargarDocumento" action="/" enctype="multipart/form-data">
            <div class="custom-input-file">
              <input type="file" id="archivoPDF" class="input-file" value="" name="documento_adjunto" onchange="leeDocumento('archivoPDF');" accept="application/pdf">
          ...
          <div id="divDocumento">
            ...
            <input type="hidden" id="nomDocPDF">
          </div>
        </div><!-- modal-body -->
        <div class="modal-footer d-flex">
