                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2-show-search valid" id="tipoPromocion" name="tipo_promocion" autocomplete="off">
                        @if ($solicitud['tipo_promocion']=="1")
                           <option value=1 selected>Petición Relacionada con carpeta judicial de la unidad de gestión</option>
                          ...
                          <option value=2 selected>Petición Relacionada a carpeta judicial de OTRA unidad de gestión</option>
                       @endif
                  </select>
                </div>
            ...
            <div class="form-group">
              ...
              <select class="form-control select2-show-search valid" id="tipoRequerimiento" name="tipo_requerimiento" autocomplete="off">
                  @if ($solicitud['id_tipo_requerimiento']==1)
                        <option value=1 selected>Promoción de Solicitud de Programación de Audiencia</option>
                        <option value=2>Promoción de Tramite</option>
                        @endif
                     @if ($solicitud['id_tipo_requerimiento']==2)
                        <option value=1>Promoción de Solicitud de Programación de Audiencia</option>
                      <option value=2 selected>Promoción de Tramite</option>
                     @endif
             </select>
            </div>
          </div><!-- col-9 -->
