    ...
    <div class="row mt-4">
      <div class="col-md-12">
        ...
        <div class="pagination-wrapper justify-content-between">
          ...
          <ul class="pagination mg-b-0">
            <li id="texto_paginator_medidac" class="page-item">Página <span class="pagina-DG pagina_actual_texto_medidac">1</span> de <span class="total-paginas-DG pagina_total_texto_medidac">1</span></li>
          </ul>
